...
func OnLlmResponse(name string, handler func(ctx context.Context, response *llm.Response) (*llm.Response, error)) Middleware {
	return &simpleMiddleware{
		name:                       name,
		outboundLlmResponseHandler: handler,
	}
}

func OnLlmStream(name string, handler func(ctx context.Context, stream streams.Stream[*llm.Response]) (streams.Stream[*llm.Response], error)) Middleware {
	return &simpleMiddleware{
		name:                     name,
		outboundLlmStreamHandler: handler,
	}
}
