...
type ResponseProtectionRulePreviewInput struct {
	Pattern  string                              `json:"pattern"`
	TestText string                              `json:"testText"`
	Settings *objects.ResponseProtectionSettings `json:"settings"`
}

type ResponseProtectionRulePreviewResult struct {
	Result   string `json:"result"`
	HasMatch bool   `json:"hasMatch"`
}
