...
func NewChatCompletionOrchestrator(
	...
	responseProtectionRuleService *biz.ResponseProtectionRuleService,
	...
	if promptProtectionRuleService != nil {
		promptProtecter = promptProtectionRuleService
	}

	var responseProtecter ResponseProtecter
	if responseProtectionRuleService != nil {
		responseProtecter = responseProtectionRuleService
	}
	...
	return &ChatCompletionOrchestrator{
		...
		ResponseProtecter:  responseProtecter,
...
func (processor *ChatCompletionOrchestrator) Process(ctx context.Context, request *httpclient.Request) (ChatCompletionResult, error) {
	...
	state := &PersistenceState{
		...
		ResponseProtecter:     processor.ResponseProtecter,
	...
	middlewares = append(middlewares,
		...
		protectResponses(inbound),
		protectResponseStream(inbound),
