...
// ResponseProtectionRuleWhereInput represents a where input for filtering ResponseProtectionRule queries.
type ResponseProtectionRuleWhereInput struct {
	Predicates []predicate.ResponseProtectionRule  `json:"-"`
	Not        *ResponseProtectionRuleWhereInput   `json:"not,omitempty"`
	Or         []*ResponseProtectionRuleWhereInput `json:"or,omitempty"`
	And        []*ResponseProtectionRuleWhereInput `json:"and,omitempty"`
	...
	StatusNEQ   *responseprotectionrule.Status  `json:"statusNEQ,omitempty"`
	StatusIn    []responseprotectionrule.Status `json:"statusIn,omitempty"`
	StatusNotIn []responseprotectionrule.Status `json:"statusNotIn,omitempty"`
}

// AddPredicates adds custom predicates to the where input to be used during the filtering phase.
func (i *ResponseProtectionRuleWhereInput) AddPredicates(predicates ...predicate.ResponseProtectionRule) {
	i.Predicates = append(i.Predicates, predicates...)
}

// Filter applies the ResponseProtectionRuleWhereInput filter on the ResponseProtectionRuleQuery builder.
func (i *ResponseProtectionRuleWhereInput) Filter(q *ResponseProtectionRuleQuery) (*ResponseProtectionRuleQuery, error) {
	if i == nil {
		return q, nil
	}
	p, err := i.P()
	if err != nil {
		if err == ErrEmptyResponseProtectionRuleWhereInput {
			return q, nil
		}
		return nil, err
	}
...
// ErrEmptyResponseProtectionRuleWhereInput is returned in case the ResponseProtectionRuleWhereInput is empty.
var ErrEmptyResponseProtectionRuleWhereInput = errors.New("ent: empty predicate ResponseProtectionRuleWhereInput")

// P returns a predicate for filtering responseprotectionrules.
// An error is returned if the input is empty or invalid.
func (i *ResponseProtectionRuleWhereInput) P() (predicate.ResponseProtectionRule, error) {
	var predicates []predicate.ResponseProtectionRule
	if i.Not != nil {
		p, err := i.Not.P()
		if err != nil {
			return nil, fmt.Errorf("%w: field 'not'", err)
		}
		predicates = append(predicates, responseprotectionrule.Not(p))
	}
	switch n := len(i.Or); {
	case n == 1:
		p, err := i.Or[0].P()
		...
		predicates = append(predicates, p)
	case n > 1:
		or := make([]predicate.ResponseProtectionRule, 0, n)
		for _, w := range i.Or {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'or'", err)
		...
		predicates = append(predicates, responseprotectionrule.Or(or...))
	}
	switch n := len(i.And); {
	case n == 1:
		p, err := i.And[0].P()
		...
		predicates = append(predicates, p)
	case n > 1:
		and := make([]predicate.ResponseProtectionRule, 0, n)
		for _, w := range i.And {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'and'", err)
		...
		predicates = append(predicates, responseprotectionrule.And(and...))
	}
	predicates = append(predicates, i.Predicates...)
	if i.ID != nil {
		predicates = append(predicates, responseprotectionrule.IDEQ(*i.ID))
	}
	if i.IDNEQ != nil {
		predicates = append(predicates, responseprotectionrule.IDNEQ(*i.IDNEQ))
	}
	if len(i.IDIn) > 0 {
		predicates = append(predicates, responseprotectionrule.IDIn(i.IDIn...))
	}
	if len(i.IDNotIn) > 0 {
		predicates = append(predicates, responseprotectionrule.IDNotIn(i.IDNotIn...))
	}
	if i.IDGT != nil {
		predicates = append(predicates, responseprotectionrule.IDGT(*i.IDGT))
	}
	if i.IDGTE != nil {
		predicates = append(predicates, responseprotectionrule.IDGTE(*i.IDGTE))
	}
	if i.IDLT != nil {
		predicates = append(predicates, responseprotectionrule.IDLT(*i.IDLT))
	}
	if i.IDLTE != nil {
		predicates = append(predicates, responseprotectionrule.IDLTE(*i.IDLTE))
	}
	if i.CreatedAt != nil {
		predicates = append(predicates, responseprotectionrule.CreatedAtEQ(*i.CreatedAt))
	}
	if i.CreatedAtNEQ != nil {
		predicates = append(predicates, responseprotectionrule.CreatedAtNEQ(*i.CreatedAtNEQ))
	}
	if len(i.CreatedAtIn) > 0 {
		predicates = append(predicates, responseprotectionrule.CreatedAtIn(i.CreatedAtIn...))
	}
	if len(i.CreatedAtNotIn) > 0 {
		predicates = append(predicates, responseprotectionrule.CreatedAtNotIn(i.CreatedAtNotIn...))
	}
	if i.CreatedAtGT != nil {
		predicates = append(predicates, responseprotectionrule.CreatedAtGT(*i.CreatedAtGT))
	}
	if i.CreatedAtGTE != nil {
		predicates = append(predicates, responseprotectionrule.CreatedAtGTE(*i.CreatedAtGTE))
	}
	if i.CreatedAtLT != nil {
		predicates = append(predicates, responseprotectionrule.CreatedAtLT(*i.CreatedAtLT))
	}
	if i.CreatedAtLTE != nil {
		predicates = append(predicates, responseprotectionrule.CreatedAtLTE(*i.CreatedAtLTE))
	}
	if i.UpdatedAt != nil {
		predicates = append(predicates, responseprotectionrule.UpdatedAtEQ(*i.UpdatedAt))
	}
	if i.UpdatedAtNEQ != nil {
		predicates = append(predicates, responseprotectionrule.UpdatedAtNEQ(*i.UpdatedAtNEQ))
	}
	if len(i.UpdatedAtIn) > 0 {
		predicates = append(predicates, responseprotectionrule.UpdatedAtIn(i.UpdatedAtIn...))
	}
	if len(i.UpdatedAtNotIn) > 0 {
		predicates = append(predicates, responseprotectionrule.UpdatedAtNotIn(i.UpdatedAtNotIn...))
	}
	if i.UpdatedAtGT != nil {
		predicates = append(predicates, responseprotectionrule.UpdatedAtGT(*i.UpdatedAtGT))
	}
	if i.UpdatedAtGTE != nil {
		predicates = append(predicates, responseprotectionrule.UpdatedAtGTE(*i.UpdatedAtGTE))
	}
	if i.UpdatedAtLT != nil {
		predicates = append(predicates, responseprotectionrule.UpdatedAtLT(*i.UpdatedAtLT))
	}
	if i.UpdatedAtLTE != nil {
		predicates = append(predicates, responseprotectionrule.UpdatedAtLTE(*i.UpdatedAtLTE))
	}
	if i.Name != nil {
		predicates = append(predicates, responseprotectionrule.NameEQ(*i.Name))
	}
	if i.NameNEQ != nil {
		predicates = append(predicates, responseprotectionrule.NameNEQ(*i.NameNEQ))
	}
	if len(i.NameIn) > 0 {
		predicates = append(predicates, responseprotectionrule.NameIn(i.NameIn...))
	}
	if len(i.NameNotIn) > 0 {
		predicates = append(predicates, responseprotectionrule.NameNotIn(i.NameNotIn...))
	}
	if i.NameGT != nil {
		predicates = append(predicates, responseprotectionrule.NameGT(*i.NameGT))
	}
	if i.NameGTE != nil {
		predicates = append(predicates, responseprotectionrule.NameGTE(*i.NameGTE))
	}
	if i.NameLT != nil {
		predicates = append(predicates, responseprotectionrule.NameLT(*i.NameLT))
	}
	if i.NameLTE != nil {
		predicates = append(predicates, responseprotectionrule.NameLTE(*i.NameLTE))
	}
	if i.NameContains != nil {
		predicates = append(predicates, responseprotectionrule.NameContains(*i.NameContains))
	}
	if i.NameHasPrefix != nil {
		predicates = append(predicates, responseprotectionrule.NameHasPrefix(*i.NameHasPrefix))
	}
	if i.NameHasSuffix != nil {
		predicates = append(predicates, responseprotectionrule.NameHasSuffix(*i.NameHasSuffix))
	}
	if i.NameEqualFold != nil {
		predicates = append(predicates, responseprotectionrule.NameEqualFold(*i.NameEqualFold))
	}
	if i.NameContainsFold != nil {
		predicates = append(predicates, responseprotectionrule.NameContainsFold(*i.NameContainsFold))
	}
	if i.Description != nil {
		predicates = append(predicates, responseprotectionrule.DescriptionEQ(*i.Description))
	}
	if i.DescriptionNEQ != nil {
		predicates = append(predicates, responseprotectionrule.DescriptionNEQ(*i.DescriptionNEQ))
	}
	if len(i.DescriptionIn) > 0 {
		predicates = append(predicates, responseprotectionrule.DescriptionIn(i.DescriptionIn...))
	}
	if len(i.DescriptionNotIn) > 0 {
		predicates = append(predicates, responseprotectionrule.DescriptionNotIn(i.DescriptionNotIn...))
	}
	if i.DescriptionGT != nil {
		predicates = append(predicates, responseprotectionrule.DescriptionGT(*i.DescriptionGT))
	}
	if i.DescriptionGTE != nil {
		predicates = append(predicates, responseprotectionrule.DescriptionGTE(*i.DescriptionGTE))
	}
	if i.DescriptionLT != nil {
		predicates = append(predicates, responseprotectionrule.DescriptionLT(*i.DescriptionLT))
	}
	if i.DescriptionLTE != nil {
		predicates = append(predicates, responseprotectionrule.DescriptionLTE(*i.DescriptionLTE))
	}
	if i.DescriptionContains != nil {
		predicates = append(predicates, responseprotectionrule.DescriptionContains(*i.DescriptionContains))
	}
	if i.DescriptionHasPrefix != nil {
		predicates = append(predicates, responseprotectionrule.DescriptionHasPrefix(*i.DescriptionHasPrefix))
	}
	if i.DescriptionHasSuffix != nil {
		predicates = append(predicates, responseprotectionrule.DescriptionHasSuffix(*i.DescriptionHasSuffix))
	}
	if i.DescriptionEqualFold != nil {
		predicates = append(predicates, responseprotectionrule.DescriptionEqualFold(*i.DescriptionEqualFold))
	}
	if i.DescriptionContainsFold != nil {
		predicates = append(predicates, responseprotectionrule.DescriptionContainsFold(*i.DescriptionContainsFold))
	}
	if i.Pattern != nil {
		predicates = append(predicates, responseprotectionrule.PatternEQ(*i.Pattern))
	}
	if i.PatternNEQ != nil {
		predicates = append(predicates, responseprotectionrule.PatternNEQ(*i.PatternNEQ))
	}
	if len(i.PatternIn) > 0 {
		predicates = append(predicates, responseprotectionrule.PatternIn(i.PatternIn...))
	}
	if len(i.PatternNotIn) > 0 {
		predicates = append(predicates, responseprotectionrule.PatternNotIn(i.PatternNotIn...))
	}
	if i.PatternGT != nil {
		predicates = append(predicates, responseprotectionrule.PatternGT(*i.PatternGT))
	}
	if i.PatternGTE != nil {
		predicates = append(predicates, responseprotectionrule.PatternGTE(*i.PatternGTE))
	}
	if i.PatternLT != nil {
		predicates = append(predicates, responseprotectionrule.PatternLT(*i.PatternLT))
	}
	if i.PatternLTE != nil {
		predicates = append(predicates, responseprotectionrule.PatternLTE(*i.PatternLTE))
	}
	if i.PatternContains != nil {
		predicates = append(predicates, responseprotectionrule.PatternContains(*i.PatternContains))
	}
	if i.PatternHasPrefix != nil {
		predicates = append(predicates, responseprotectionrule.PatternHasPrefix(*i.PatternHasPrefix))
	}
	if i.PatternHasSuffix != nil {
		predicates = append(predicates, responseprotectionrule.PatternHasSuffix(*i.PatternHasSuffix))
	}
	if i.PatternEqualFold != nil {
		predicates = append(predicates, responseprotectionrule.PatternEqualFold(*i.PatternEqualFold))
	}
	if i.PatternContainsFold != nil {
		predicates = append(predicates, responseprotectionrule.PatternContainsFold(*i.PatternContainsFold))
	}
	if i.Status != nil {
		predicates = append(predicates, responseprotectionrule.StatusEQ(*i.Status))
	}
	if i.StatusNEQ != nil {
		predicates = append(predicates, responseprotectionrule.StatusNEQ(*i.StatusNEQ))
	}
	if len(i.StatusIn) > 0 {
		predicates = append(predicates, responseprotectionrule.StatusIn(i.StatusIn...))
	}
	if len(i.StatusNotIn) > 0 {
		predicates = append(predicates, responseprotectionrule.StatusNotIn(i.StatusNotIn...))
	}

	switch len(predicates) {
	case 0:
		return nil, ErrEmptyResponseProtectionRuleWhereInput
	case 1:
		return predicates[0], nil
	default:
		return responseprotectionrule.And(predicates...), nil
	}
}
