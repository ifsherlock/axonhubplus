...
var (
	...
	// ResponseProtectionRulesColumns holds the columns for the "response_protection_rules" table.
	ResponseProtectionRulesColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "created_at", Type: field.TypeTime, Default: schema.Expr("CURRENT_TIMESTAMP")},
		{Name: "updated_at", Type: field.TypeTime, Default: schema.Expr("CURRENT_TIMESTAMP")},
		{Name: "deleted_at", Type: field.TypeInt, Default: 0},
	...
	// ResponseProtectionRulesTable holds the schema information for the "response_protection_rules" table.
	ResponseProtectionRulesTable = &schema.Table{
		Name:       "response_protection_rules",
		Columns:    ResponseProtectionRulesColumns,
		PrimaryKey: []*schema.Column{ResponseProtectionRulesColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "response_protection_rules_by_name",
				Unique:  true,
				Columns: []*schema.Column{ResponseProtectionRulesColumns[4], ResponseProtectionRulesColumns[3]},
			},
		},
	}
