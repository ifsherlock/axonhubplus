...
var schemaGraph = func() *sqlgraph.Schema {
	...
	graph.Nodes[16] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			Table:   responseprotectionrule.Table,
		...
		Type: "ResponseProtectionRule",
		Fields: map[string]*sqlgraph.FieldSpec{
			responseprotectionrule.FieldCreatedAt:   {Type: field.TypeTime, Column: responseprotectionrule.FieldCreatedAt},
			responseprotectionrule.FieldUpdatedAt:   {Type: field.TypeTime, Column: responseprotectionrule.FieldUpdatedAt},
			responseprotectionrule.FieldDeletedAt:   {Type: field.TypeInt, Column: responseprotectionrule.FieldDeletedAt},
			responseprotectionrule.FieldName:        {Type: field.TypeString, Column: responseprotectionrule.FieldName},
			responseprotectionrule.FieldDescription: {Type: field.TypeString, Column: responseprotectionrule.FieldDescription},
			responseprotectionrule.FieldPattern:     {Type: field.TypeString, Column: responseprotectionrule.FieldPattern},
			responseprotectionrule.FieldStatus:      {Type: field.TypeEnum, Column: responseprotectionrule.FieldStatus},
			responseprotectionrule.FieldSettings:    {Type: field.TypeJSON, Column: responseprotectionrule.FieldSettings},
		},
	}
...
// addPredicate implements the predicateAdder interface.
func (_q *ResponseProtectionRuleQuery) addPredicate(pred func(s *sql.Selector)) {
	_q.predicates = append(_q.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the ResponseProtectionRuleQuery builder.
func (_q *ResponseProtectionRuleQuery) Filter() *ResponseProtectionRuleFilter {
	return &ResponseProtectionRuleFilter{config: _q.config, predicateAdder: _q}
}

// addPredicate implements the predicateAdder interface.
func (m *ResponseProtectionRuleMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the ResponseProtectionRuleMutation builder.
func (m *ResponseProtectionRuleMutation) Filter() *ResponseProtectionRuleFilter {
	return &ResponseProtectionRuleFilter{config: m.config, predicateAdder: m}
}

// ResponseProtectionRuleFilter provides a generic filtering capability at runtime for ResponseProtectionRuleQuery.
type ResponseProtectionRuleFilter struct {
	predicateAdder
	config
}

// Where applies the entql predicate on the query filter.
func (f *ResponseProtectionRuleFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql int predicate on the id field.
func (f *ResponseProtectionRuleFilter) WhereID(p entql.IntP) {
	f.Where(p.Field(responseprotectionrule.FieldID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *ResponseProtectionRuleFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(responseprotectionrule.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *ResponseProtectionRuleFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(responseprotectionrule.FieldUpdatedAt))
}

// WhereDeletedAt applies the entql int predicate on the deleted_at field.
func (f *ResponseProtectionRuleFilter) WhereDeletedAt(p entql.IntP) {
	f.Where(p.Field(responseprotectionrule.FieldDeletedAt))
}

// WhereName applies the entql string predicate on the name field.
func (f *ResponseProtectionRuleFilter) WhereName(p entql.StringP) {
	f.Where(p.Field(responseprotectionrule.FieldName))
}

// WhereDescription applies the entql string predicate on the description field.
func (f *ResponseProtectionRuleFilter) WhereDescription(p entql.StringP) {
	f.Where(p.Field(responseprotectionrule.FieldDescription))
}

// WherePattern applies the entql string predicate on the pattern field.
func (f *ResponseProtectionRuleFilter) WherePattern(p entql.StringP) {
	f.Where(p.Field(responseprotectionrule.FieldPattern))
}

// WhereStatus applies the entql string predicate on the status field.
func (f *ResponseProtectionRuleFilter) WhereStatus(p entql.StringP) {
	f.Where(p.Field(responseprotectionrule.FieldStatus))
}

// WhereSettings applies the entql json.RawMessage predicate on the settings field.
func (f *ResponseProtectionRuleFilter) WhereSettings(p entql.BytesP) {
	f.Where(p.Field(responseprotectionrule.FieldSettings))
}
