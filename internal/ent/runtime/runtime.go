...
func init() {
	...
	responseprotectionruleMixin := schema.ResponseProtectionRule{}.Mixin()
	responseprotectionrule.Policy = privacy.NewPolicies(schema.ResponseProtectionRule{})
	responseprotectionrule.Hooks[0] = func(next ent.Mutator) ent.Mutator {
		return ent.MutateFunc(func(ctx context.Context, m ent.Mutation) (ent.Value, error) {
			if err := responseprotectionrule.Policy.EvalMutation(ctx, m); err != nil {
				return nil, err
			}
			return next.Mutate(ctx, m)
		})
	}
	responseprotectionruleMixinHooks1 := responseprotectionruleMixin[1].Hooks()

	responseprotectionrule.Hooks[1] = responseprotectionruleMixinHooks1[0]
	responseprotectionruleMixinInters1 := responseprotectionruleMixin[1].Interceptors()
	responseprotectionrule.Interceptors[0] = responseprotectionruleMixinInters1[0]
	responseprotectionruleMixinFields0 := responseprotectionruleMixin[0].Fields()
	_ = responseprotectionruleMixinFields0
	responseprotectionruleMixinFields1 := responseprotectionruleMixin[1].Fields()
	_ = responseprotectionruleMixinFields1
	responseprotectionruleFields := schema.ResponseProtectionRule{}.Fields()
	_ = responseprotectionruleFields
	// responseprotectionruleDescCreatedAt is the schema descriptor for created_at field.
	responseprotectionruleDescCreatedAt := responseprotectionruleMixinFields0[0].Descriptor()
	// responseprotectionrule.DefaultCreatedAt holds the default value on creation for the created_at field.
	responseprotectionrule.DefaultCreatedAt = responseprotectionruleDescCreatedAt.Default.(func() time.Time)
	// responseprotectionruleDescUpdatedAt is the schema descriptor for updated_at field.
	responseprotectionruleDescUpdatedAt := responseprotectionruleMixinFields0[1].Descriptor()
	// responseprotectionrule.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	responseprotectionrule.DefaultUpdatedAt = responseprotectionruleDescUpdatedAt.Default.(func() time.Time)
	// responseprotectionrule.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	responseprotectionrule.UpdateDefaultUpdatedAt = responseprotectionruleDescUpdatedAt.UpdateDefault.(func() time.Time)
	// responseprotectionruleDescDeletedAt is the schema descriptor for deleted_at field.
	responseprotectionruleDescDeletedAt := responseprotectionruleMixinFields1[0].Descriptor()
	// responseprotectionrule.DefaultDeletedAt holds the default value on creation for the deleted_at field.
	responseprotectionrule.DefaultDeletedAt = responseprotectionruleDescDeletedAt.Default.(int)
	// responseprotectionruleDescDescription is the schema descriptor for description field.
	responseprotectionruleDescDescription := responseprotectionruleFields[1].Descriptor()
	// responseprotectionrule.DefaultDescription holds the default value on creation for the description field.
	responseprotectionrule.DefaultDescription = responseprotectionruleDescDescription.Default.(string)
