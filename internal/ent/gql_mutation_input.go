...
// CreateResponseProtectionRuleInput represents a mutation input for creating responseprotectionrules.
type CreateResponseProtectionRuleInput struct {
	Name        string
	Description *string
	Pattern     string
...
// Mutate applies the CreateResponseProtectionRuleInput on the ResponseProtectionRuleMutation builder.
func (i *CreateResponseProtectionRuleInput) Mutate(m *ResponseProtectionRuleMutation) {
	m.SetName(i.Name)
	if v := i.Description; v != nil {
		m.SetDescription(*v)
	}
...
// SetInput applies the change-set in the CreateResponseProtectionRuleInput on the ResponseProtectionRuleCreate builder.
func (c *ResponseProtectionRuleCreate) SetInput(i CreateResponseProtectionRuleInput) *ResponseProtectionRuleCreate {
	i.Mutate(c.Mutation())
	return c
}

// UpdateResponseProtectionRuleInput represents a mutation input for updating responseprotectionrules.
type UpdateResponseProtectionRuleInput struct {
	Name        *string
	Description *string
	Pattern     *string
...
// Mutate applies the UpdateResponseProtectionRuleInput on the ResponseProtectionRuleMutation builder.
func (i *UpdateResponseProtectionRuleInput) Mutate(m *ResponseProtectionRuleMutation) {
	if v := i.Name; v != nil {
		m.SetName(*v)
	}
	if v := i.Description; v != nil {
...
// SetInput applies the change-set in the UpdateResponseProtectionRuleInput on the ResponseProtectionRuleUpdate builder.
func (c *ResponseProtectionRuleUpdate) SetInput(i UpdateResponseProtectionRuleInput) *ResponseProtectionRuleUpdate {
	i.Mutate(c.Mutation())
	return c
}

// SetInput applies the change-set in the UpdateResponseProtectionRuleInput on the ResponseProtectionRuleUpdateOne builder.
func (c *ResponseProtectionRuleUpdateOne) SetInput(i UpdateResponseProtectionRuleInput) *ResponseProtectionRuleUpdateOne {
	i.Mutate(c.Mutation())
	return c
}
