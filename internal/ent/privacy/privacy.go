...
// The ResponseProtectionRuleQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type ResponseProtectionRuleQueryRuleFunc func(context.Context, *ent.ResponseProtectionRuleQuery) error

// EvalQuery return f(ctx, q).
func (f ResponseProtectionRuleQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.ResponseProtectionRuleQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.ResponseProtectionRuleQuery", q)
}

// The ResponseProtectionRuleMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type ResponseProtectionRuleMutationRuleFunc func(context.Context, *ent.ResponseProtectionRuleMutation) error

// EvalMutation calls f(ctx, m).
func (f ResponseProtectionRuleMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.ResponseProtectionRuleMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.ResponseProtectionRuleMutation", m)
}
...
func mutationFilter(m ent.Mutation) (Filter, error) {
	...
	case *ent.RequestExecutionMutation:
		return m.Filter(), nil
	case *ent.ResponseProtectionRuleMutation:
		return m.Filter(), nil
