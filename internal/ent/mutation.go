...
const (
	...
	TypeResponseProtectionRule   = "ResponseProtectionRule"
	TypeRole                     = "Role"
	TypeSystem                   = "System"
	TypeThread                   = "Thread"
	TypeTrace                    = "Trace"
...
// ResponseProtectionRuleMutation represents an operation that mutates the ResponseProtectionRule nodes in the graph.
type ResponseProtectionRuleMutation struct {
	config
	op            Op
	typ           string
	id            *int
	...
	description   *string
	pattern       *string
	status        *responseprotectionrule.Status
	settings      **objects.ResponseProtectionSettings
	clearedFields map[string]struct{}
	done          bool
	oldValue      func(context.Context) (*ResponseProtectionRule, error)
	predicates    []predicate.ResponseProtectionRule
}

var _ ent.Mutation = (*ResponseProtectionRuleMutation)(nil)

// responseprotectionruleOption allows management of the mutation configuration using functional options.
type responseprotectionruleOption func(*ResponseProtectionRuleMutation)

// newResponseProtectionRuleMutation creates new mutation for the ResponseProtectionRule entity.
func newResponseProtectionRuleMutation(c config, op Op, opts ...responseprotectionruleOption) *ResponseProtectionRuleMutation {
	m := &ResponseProtectionRuleMutation{
		config:        c,
		op:            op,
		typ:           TypeResponseProtectionRule,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withResponseProtectionRuleID sets the ID field of the mutation.
func withResponseProtectionRuleID(id int) responseprotectionruleOption {
	return func(m *ResponseProtectionRuleMutation) {
		var (
			err   error
			once  sync.Once
			value *ResponseProtectionRule
		)
		m.oldValue = func(ctx context.Context) (*ResponseProtectionRule, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().ResponseProtectionRule.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withResponseProtectionRule sets the old ResponseProtectionRule of the mutation.
func withResponseProtectionRule(node *ResponseProtectionRule) responseprotectionruleOption {
	return func(m *ResponseProtectionRuleMutation) {
		m.oldValue = func(context.Context) (*ResponseProtectionRule, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m ResponseProtectionRuleMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m ResponseProtectionRuleMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *ResponseProtectionRuleMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *ResponseProtectionRuleMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().ResponseProtectionRule.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetCreatedAt sets the "created_at" field.
func (m *ResponseProtectionRuleMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *ResponseProtectionRuleMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the ResponseProtectionRule entity.
// If the ResponseProtectionRule object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ResponseProtectionRuleMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreatedAt resets all changes to the "created_at" field.
func (m *ResponseProtectionRuleMutation) ResetCreatedAt() {
	m.created_at = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *ResponseProtectionRuleMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *ResponseProtectionRuleMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the ResponseProtectionRule entity.
// If the ResponseProtectionRule object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ResponseProtectionRuleMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUpdatedAt resets all changes to the "updated_at" field.
func (m *ResponseProtectionRuleMutation) ResetUpdatedAt() {
	m.updated_at = nil
}

// SetDeletedAt sets the "deleted_at" field.
func (m *ResponseProtectionRuleMutation) SetDeletedAt(i int) {
	m.deleted_at = &i
	m.adddeleted_at = nil
}

// DeletedAt returns the value of the "deleted_at" field in the mutation.
func (m *ResponseProtectionRuleMutation) DeletedAt() (r int, exists bool) {
	v := m.deleted_at
	if v == nil {
		return
	}
...
// OldDeletedAt returns the old "deleted_at" field's value of the ResponseProtectionRule entity.
// If the ResponseProtectionRule object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ResponseProtectionRuleMutation) OldDeletedAt(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldDeletedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddDeletedAt adds i to the "deleted_at" field.
func (m *ResponseProtectionRuleMutation) AddDeletedAt(i int) {
	if m.adddeleted_at != nil {
		*m.adddeleted_at += i
	} else {
		m.adddeleted_at = &i
...
// AddedDeletedAt returns the value that was added to the "deleted_at" field in this mutation.
func (m *ResponseProtectionRuleMutation) AddedDeletedAt() (r int, exists bool) {
	v := m.adddeleted_at
	if v == nil {
		return
	}
...
// ResetDeletedAt resets all changes to the "deleted_at" field.
func (m *ResponseProtectionRuleMutation) ResetDeletedAt() {
	m.deleted_at = nil
	m.adddeleted_at = nil
}

// SetName sets the "name" field.
func (m *ResponseProtectionRuleMutation) SetName(s string) {
	m.name = &s
}

// Name returns the value of the "name" field in the mutation.
func (m *ResponseProtectionRuleMutation) Name() (r string, exists bool) {
	v := m.name
	if v == nil {
		return
	}
...
// OldName returns the old "name" field's value of the ResponseProtectionRule entity.
// If the ResponseProtectionRule object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ResponseProtectionRuleMutation) OldName(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldName is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetName resets all changes to the "name" field.
func (m *ResponseProtectionRuleMutation) ResetName() {
	m.name = nil
}

// SetDescription sets the "description" field.
func (m *ResponseProtectionRuleMutation) SetDescription(s string) {
	m.description = &s
}

// Description returns the value of the "description" field in the mutation.
func (m *ResponseProtectionRuleMutation) Description() (r string, exists bool) {
	v := m.description
	if v == nil {
		return
	}
...
// OldDescription returns the old "description" field's value of the ResponseProtectionRule entity.
// If the ResponseProtectionRule object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ResponseProtectionRuleMutation) OldDescription(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldDescription is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetDescription resets all changes to the "description" field.
func (m *ResponseProtectionRuleMutation) ResetDescription() {
	m.description = nil
}

// SetPattern sets the "pattern" field.
func (m *ResponseProtectionRuleMutation) SetPattern(s string) {
	m.pattern = &s
}

// Pattern returns the value of the "pattern" field in the mutation.
func (m *ResponseProtectionRuleMutation) Pattern() (r string, exists bool) {
	v := m.pattern
	if v == nil {
		return
	}
...
// OldPattern returns the old "pattern" field's value of the ResponseProtectionRule entity.
// If the ResponseProtectionRule object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ResponseProtectionRuleMutation) OldPattern(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldPattern is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetPattern resets all changes to the "pattern" field.
func (m *ResponseProtectionRuleMutation) ResetPattern() {
	m.pattern = nil
}

// SetStatus sets the "status" field.
func (m *ResponseProtectionRuleMutation) SetStatus(r responseprotectionrule.Status) {
	m.status = &r
}

// Status returns the value of the "status" field in the mutation.
func (m *ResponseProtectionRuleMutation) Status() (r responseprotectionrule.Status, exists bool) {
	v := m.status
	if v == nil {
		return
	}
...
// OldStatus returns the old "status" field's value of the ResponseProtectionRule entity.
// If the ResponseProtectionRule object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ResponseProtectionRuleMutation) OldStatus(ctx context.Context) (v responseprotectionrule.Status, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldStatus is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetStatus resets all changes to the "status" field.
func (m *ResponseProtectionRuleMutation) ResetStatus() {
	m.status = nil
}

// SetSettings sets the "settings" field.
func (m *ResponseProtectionRuleMutation) SetSettings(ops *objects.ResponseProtectionSettings) {
	m.settings = &ops
}

// Settings returns the value of the "settings" field in the mutation.
func (m *ResponseProtectionRuleMutation) Settings() (r *objects.ResponseProtectionSettings, exists bool) {
	v := m.settings
	if v == nil {
		return
	}
...
// OldSettings returns the old "settings" field's value of the ResponseProtectionRule entity.
// If the ResponseProtectionRule object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ResponseProtectionRuleMutation) OldSettings(ctx context.Context) (v *objects.ResponseProtectionSettings, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldSettings is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetSettings resets all changes to the "settings" field.
func (m *ResponseProtectionRuleMutation) ResetSettings() {
	m.settings = nil
}

// Where appends a list predicates to the ResponseProtectionRuleMutation builder.
func (m *ResponseProtectionRuleMutation) Where(ps ...predicate.ResponseProtectionRule) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the ResponseProtectionRuleMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *ResponseProtectionRuleMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.ResponseProtectionRule, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *ResponseProtectionRuleMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *ResponseProtectionRuleMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (ResponseProtectionRule).
func (m *ResponseProtectionRuleMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *ResponseProtectionRuleMutation) Fields() []string {
	fields := make([]string, 0, 8)
	if m.created_at != nil {
		fields = append(fields, responseprotectionrule.FieldCreatedAt)
	}
	if m.updated_at != nil {
		fields = append(fields, responseprotectionrule.FieldUpdatedAt)
	}
	if m.deleted_at != nil {
		fields = append(fields, responseprotectionrule.FieldDeletedAt)
	}
	if m.name != nil {
		fields = append(fields, responseprotectionrule.FieldName)
	}
	if m.description != nil {
		fields = append(fields, responseprotectionrule.FieldDescription)
	}
	if m.pattern != nil {
		fields = append(fields, responseprotectionrule.FieldPattern)
	}
	if m.status != nil {
		fields = append(fields, responseprotectionrule.FieldStatus)
	}
	if m.settings != nil {
		fields = append(fields, responseprotectionrule.FieldSettings)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *ResponseProtectionRuleMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *ResponseProtectionRuleMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case responseprotectionrule.FieldCreatedAt:
		return m.OldCreatedAt(ctx)
	case responseprotectionrule.FieldUpdatedAt:
	...
	return nil, fmt.Errorf("unknown ResponseProtectionRule field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *ResponseProtectionRuleMutation) SetField(name string, value ent.Value) error {
	switch name {
	case responseprotectionrule.FieldCreatedAt:
		v, ok := value.(time.Time)
		if !ok {
	...
	case responseprotectionrule.FieldPattern:
		...
		return nil
	case responseprotectionrule.FieldStatus:
		v, ok := value.(responseprotectionrule.Status)
		if !ok {
			return fmt.Errorf("unexpected type %T for field %s", value, name)
		}
		m.SetStatus(v)
		return nil
	case responseprotectionrule.FieldSettings:
		v, ok := value.(*objects.ResponseProtectionSettings)
		if !ok {
			return fmt.Errorf("unexpected type %T for field %s", value, name)
		}
		m.SetSettings(v)
	...
	return fmt.Errorf("unknown ResponseProtectionRule field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *ResponseProtectionRuleMutation) AddedFields() []string {
	var fields []string
	if m.adddeleted_at != nil {
		fields = append(fields, responseprotectionrule.FieldDeletedAt)
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *ResponseProtectionRuleMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case responseprotectionrule.FieldDeletedAt:
		return m.AddedDeletedAt()
	}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *ResponseProtectionRuleMutation) AddField(name string, value ent.Value) error {
	switch name {
	case responseprotectionrule.FieldDeletedAt:
		v, ok := value.(int)
		if !ok {
	...
	return fmt.Errorf("unknown ResponseProtectionRule numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *ResponseProtectionRuleMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *ResponseProtectionRuleMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *ResponseProtectionRuleMutation) ClearField(name string) error {
	return fmt.Errorf("unknown ResponseProtectionRule nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *ResponseProtectionRuleMutation) ResetField(name string) error {
	switch name {
	case responseprotectionrule.FieldCreatedAt:
		m.ResetCreatedAt()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *ResponseProtectionRuleMutation) AddedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *ResponseProtectionRuleMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *ResponseProtectionRuleMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *ResponseProtectionRuleMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *ResponseProtectionRuleMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *ResponseProtectionRuleMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *ResponseProtectionRuleMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown ResponseProtectionRule unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *ResponseProtectionRuleMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown ResponseProtectionRule edge %s", name)
}
