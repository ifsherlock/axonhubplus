...
type Client struct {
	...
	// ResponseProtectionRule is the client for interacting with the ResponseProtectionRule builders.
	ResponseProtectionRule *ResponseProtectionRuleClient
...
func (c *Client) init() {
	...
	c.ResponseProtectionRule = NewResponseProtectionRuleClient(c.config)
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	return &Tx{
		...
		ResponseProtectionRule:   NewResponseProtectionRuleClient(cfg),
...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.ResponseProtectionRule, c.Role, c.System, c.Thread, c.Trace, c.UsageLog,
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	case *ResponseProtectionRuleMutation:
		return c.ResponseProtectionRule.mutate(ctx, m)
	case *RoleMutation:
...
// ResponseProtectionRuleClient is a client for the ResponseProtectionRule schema.
type ResponseProtectionRuleClient struct {
	config
}

// NewResponseProtectionRuleClient returns a client for the ResponseProtectionRule from the given config.
func NewResponseProtectionRuleClient(c config) *ResponseProtectionRuleClient {
	return &ResponseProtectionRuleClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `responseprotectionrule.Hooks(f(g(h())))`.
func (c *ResponseProtectionRuleClient) Use(hooks ...Hook) {
	c.hooks.ResponseProtectionRule = append(c.hooks.ResponseProtectionRule, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `responseprotectionrule.Intercept(f(g(h())))`.
func (c *ResponseProtectionRuleClient) Intercept(interceptors ...Interceptor) {
	c.inters.ResponseProtectionRule = append(c.inters.ResponseProtectionRule, interceptors...)
}

// Create returns a builder for creating a ResponseProtectionRule entity.
func (c *ResponseProtectionRuleClient) Create() *ResponseProtectionRuleCreate {
	mutation := newResponseProtectionRuleMutation(c.config, OpCreate)
	return &ResponseProtectionRuleCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of ResponseProtectionRule entities.
func (c *ResponseProtectionRuleClient) CreateBulk(builders ...*ResponseProtectionRuleCreate) *ResponseProtectionRuleCreateBulk {
	return &ResponseProtectionRuleCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *ResponseProtectionRuleClient) MapCreateBulk(slice any, setFunc func(*ResponseProtectionRuleCreate, int)) *ResponseProtectionRuleCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &ResponseProtectionRuleCreateBulk{err: fmt.Errorf("calling to ResponseProtectionRuleClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*ResponseProtectionRuleCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for ResponseProtectionRule.
func (c *ResponseProtectionRuleClient) Update() *ResponseProtectionRuleUpdate {
	mutation := newResponseProtectionRuleMutation(c.config, OpUpdate)
	return &ResponseProtectionRuleUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *ResponseProtectionRuleClient) UpdateOne(_m *ResponseProtectionRule) *ResponseProtectionRuleUpdateOne {
	mutation := newResponseProtectionRuleMutation(c.config, OpUpdateOne, withResponseProtectionRule(_m))
	return &ResponseProtectionRuleUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *ResponseProtectionRuleClient) UpdateOneID(id int) *ResponseProtectionRuleUpdateOne {
	mutation := newResponseProtectionRuleMutation(c.config, OpUpdateOne, withResponseProtectionRuleID(id))
	return &ResponseProtectionRuleUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for ResponseProtectionRule.
func (c *ResponseProtectionRuleClient) Delete() *ResponseProtectionRuleDelete {
	mutation := newResponseProtectionRuleMutation(c.config, OpDelete)
	return &ResponseProtectionRuleDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *ResponseProtectionRuleClient) DeleteOne(_m *ResponseProtectionRule) *ResponseProtectionRuleDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *ResponseProtectionRuleClient) DeleteOneID(id int) *ResponseProtectionRuleDeleteOne {
	builder := c.Delete().Where(responseprotectionrule.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &ResponseProtectionRuleDeleteOne{builder}
}

// Query returns a query builder for ResponseProtectionRule.
func (c *ResponseProtectionRuleClient) Query() *ResponseProtectionRuleQuery {
	return &ResponseProtectionRuleQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeResponseProtectionRule},
		inters: c.Interceptors(),
	}
}

// Get returns a ResponseProtectionRule entity by its id.
func (c *ResponseProtectionRuleClient) Get(ctx context.Context, id int) (*ResponseProtectionRule, error) {
	return c.Query().Where(responseprotectionrule.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *ResponseProtectionRuleClient) GetX(ctx context.Context, id int) *ResponseProtectionRule {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *ResponseProtectionRuleClient) Hooks() []Hook {
	hooks := c.hooks.ResponseProtectionRule
	return append(hooks[:len(hooks):len(hooks)], responseprotectionrule.Hooks[:]...)
}

// Interceptors returns the client interceptors.
func (c *ResponseProtectionRuleClient) Interceptors() []Interceptor {
	inters := c.inters.ResponseProtectionRule
	return append(inters[:len(inters):len(inters)], responseprotectionrule.Interceptors[:]...)
}

func (c *ResponseProtectionRuleClient) mutate(ctx context.Context, m *ResponseProtectionRuleMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&ResponseProtectionRuleCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&ResponseProtectionRuleUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&ResponseProtectionRuleUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&ResponseProtectionRuleDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("ent: unknown ResponseProtectionRule mutation op: %q", m.Op())
	}
}
...
type (
	hooks struct {
		...
		ProviderQuotaStatus, Request, RequestExecution, ResponseProtectionRule, Role,
